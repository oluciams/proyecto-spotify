  ...
  return(  
    <div className="container">
      <section className="row justify-content-sm center row-cols-auto">
        ...
        { albums.map(({id, images, name, artists, total_tracks, external_urls })=> 
            <div key={id} className="mt-3 mx-auto">
              <div  className="card h-100" style={{width: "18rem"}}>
                ...
                <div className="card-body">
                  ...
                  <a href={external_urls.spotify} target="_blank" rel="noreferrer" className="btn btn-info">Go album</a>           
                </div>
              </div>   
            </div> 
          )
